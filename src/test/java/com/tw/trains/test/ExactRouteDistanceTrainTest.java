...
import com.tw.trains.provider.ExactRouteDistanceSearchProvider;
...
public class ExactRouteDistanceTrainTest {
    ...
    public void shouldReturnEightDistanceForSpecialRouteTrainWhenStartAAndEndBAndPassB() {
        ...
        ExactRouteDistanceSearchProvider provider = new ExactRouteDistanceSearchProvider(listTown, container);
