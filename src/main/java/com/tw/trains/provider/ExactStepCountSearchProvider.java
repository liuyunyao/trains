...
public class ExactStepCountSearchProvider extends BaseSearchProvider {

    private Town start;
    private Town end;
    private int exactStep;

    public ExactStepCountSearchProvider(Town start, Town end, int exactStep, TownContainer container) {
        super(container);
        this.start = start;
        this.end = end;
